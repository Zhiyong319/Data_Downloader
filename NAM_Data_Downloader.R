...
# from https://eternallybored.org/misc/wget/ and place the executable in the same folder with this
# R script.
...
### login (register an account first)
email = "your_email"
pass <- "your_password"
...
### time period
Sys.setenv(TZ='GMT')
date_start <- "2019-07-08"  # start date
date_end <- "2020-01-01"  # end date
